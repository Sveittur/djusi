    ...
    extend: {
      ...
      keyframes: {
        fadeUpOut: {
          ...
          '100%': { opacity: '0', transform: 'translateY(-50px)' }, // Move higher up
        },
        fadeUpIn: {
          '0%': { opacity: '0', transform: 'translateY(50px)' }, // Start lower
          '100%': { opacity: '1', transform: 'translateY(0)' },
        },
        textOutLeft: {
          '0%': { opacity: '1', transform: 'translateX(0)' },
          '100%': { opacity: '0', transform: 'translateX(-400px)' }, // Move further left
        },
        textInRight: {
          '0%': { opacity: '0', transform: 'translateX(200px)' }, // Start further to the right
